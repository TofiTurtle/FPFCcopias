package object Datos {
 ...
 /*
// ===== Datos de juguete del enunciado =====
...
*/
 //datos REALES AYYY AGARRENSE DURO PAPA
...
//} el champion esta comentado pq esta demasiado lejos y no lo reconocen XD